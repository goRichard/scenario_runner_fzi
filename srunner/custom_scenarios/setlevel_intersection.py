...
class SetLevelIntersection(BasicScenario):
    ...
    def _create_behavior(self):
        ...
        #start_first_actor_trigger = InTriggerDistanceToLocation(
        #    self.ego_vehicles[0],
        #    carla.Location(258.6, -195.6, 0.19), 1.5)
        #root.add_child(start_first_actor_trigger)

        goal = carla.Location(262.71, -284.57, 0.19)
        #actor1 = BasicAgentBehavior(self.other_actors[0], goal)
